...
namespace MicrosoftGroupChatClient
{
    public class GroupChat
    {
        ...
        public GroupChat(ConsoleEventLog eventLog, Uri userSipUri, string ocsServer, string ocsUsername, string ocsPassword, Uri lookupServerUri, string chatRoomName)
        {
            _eventLog = eventLog;
