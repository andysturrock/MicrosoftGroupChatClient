...
using MicrosoftGroupChatClient;
...
namespace MicrosoftGroupChatClient
{
    public class GroupChat
    {
        ...
        private void OnTimerEvent(object source, ElapsedEventArgs e)
        {
            try
            {
                Console.Out.WriteLine("UserEndPoint status = " + _userEndpoint.State.ToString());
                Console.Out.WriteLine("GroupChatEndPoint status = " + _groupChatEndpoint.State.ToString());
                Console.Out.WriteLine("Chatroom status = " + _chatRoomSession.State.ToString());
            }
            catch (Exception)
            {
                // Ignore for now
